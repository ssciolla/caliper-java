...
public enum CaliperJsonldContextIRI implements CaliperJsonldContext {
    ...
    private static Map<String, CaliperJsonldContextIRI> lookup;

    /**
     * Create reverse lookup hash map
     */
    static {
        Map<String, CaliperJsonldContextIRI> map = new HashMap<String, CaliperJsonldContextIRI>();
        for (CaliperJsonldContextIRI constants : CaliperJsonldContextIRI.values()) {
     ...
     * @param value
     */
    private CaliperJsonldContextIRI(final String value) {
        this.value = value;
    }
