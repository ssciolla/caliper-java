...
public class AssignableEventActivatedTest {
    ...
    public void setUp() throws Exception {
        ...
        // Build event
        event = buildEvent(Profile.ASSIGNABLE, Action.ACTIVATED);
    }
    ...
    public void caliperEventSerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEventAssignableActivated.json");
        JSONAssert.assertEquals(fixture, json, JSONCompareMode.NON_EXTENSIBLE);
    }

    @Test(expected=IllegalArgumentException.class)
    public void assignableEventRejectsSearchedAction() {
        buildEvent(Profile.ASSIGNABLE, Action.SEARCHED);
    }
    ...
    /**
     * Build AssignableEvent.
     * @param profile, action
     * @return event
     */
    private AssignableEvent buildEvent(CaliperProfile profile, CaliperAction action) {
