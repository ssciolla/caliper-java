...
public class MediaEventPausedTest {
    ...
    public void setUp() throws Exception {
        ...
        // Build event
        event = buildEvent(Profile.MEDIA ,Action.PAUSED);
    }
    ...
    public void caliperEventSerializesToJSON() throws Exception {
        ...
        String fixture = jsonFixture("fixtures/v1p2/caliperEventMediaPausedVideo.json");
        JSONAssert.assertEquals(fixture, json, JSONCompareMode.NON_EXTENSIBLE);
    }

    @Test(expected=IllegalArgumentException.class)
    public void mediaEventRejectsSubmittedAction() {
        buildEvent(Profile.MEDIA, Action.SUBMITTED);
    }
     ...
     * @return event
     */
    private MediaEvent buildEvent(CaliperProfile profile, CaliperAction action) {
